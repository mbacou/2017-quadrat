...
The final quadrant classifications are shown below after overlaying zones of low/high market access (using below/above 4hrs to nearest 100K market for the 2 countries).
